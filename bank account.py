...
account = BankAccount(account_number="015867234", customer_name="clive opiyo", date_of_opening="2024-10-20", balance=10000)
...
print(account.withdraw(15000)) # Trying to withdraw more than the balance
